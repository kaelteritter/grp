          ...
          {activeTab === 'basic' && (
            <>
              ...
              <div>
                ...
                <input type="text" name="hair_color" value={formData.hair_color} onChange={handleChange} className="w-full bg-transparent border-b border-gray-800 py-2 text-sm" />
              </div>
            </>
          )}
            ...
            <>
              ...
              <div>
                ...
                >
                  ...
                  <span className="text-gray-500 text-sm">
                    {videos.length > 0 ? `${videos.length} video(s) selected` : 'Click or drag to upload videos'}
                  </span>
                </div>
              </div>
